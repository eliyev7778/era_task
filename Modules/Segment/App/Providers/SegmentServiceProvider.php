...
namespace Modules\Segment\App\Providers;
...
use Modules\Segment\App\Repositories\Eloquent\SegmentRepository;
use Modules\Segment\App\Repositories\Eloquent\UserRepository;

class SegmentServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Segment';

    protected string $moduleNameLower = 'segment';
